...
| 日期 | 文件 | 内容 |
|------|------|------|
| 09-01 | [message-content-sanitize](dev-log/2026-09-01-message-content-sanitize.md) | **消息内容写入 Postgres 失败排查** — 根因 NUL/控制字符/lone surrogate、DrizzleQueryError 藏 cause、sanitizeDbText 清洗 + 暴露 cause |

### 2026-08

| 日期 | 文件 | 内容 |
|------|------|------|
| 08-31 | [neon-rag-deployment](dev-log/2026-08-31-neon-rag-deployment.md) | **RAG 上线 Neon** — 部署 3 步（pgvector/建表/灌库）、TCP 被重置改走 neon-http 的网络踩坑 |
...
| 08-03 | [agent-toolcall-ui-redesign](dev-log/2026-08-03-agent-toolcall-ui-redesign.md) | **Agent 工具调用指示器 UI 重设计** — V0 大卡片→V1 横排栏(失败)→V2 内联脚注→V3 卡片式、聚合头/双栏详情/耗时展示/后端补转 success |
...
| **RAG 知识库** | [完整设计](dev-log/2026-08-19-rag-knowledge-base-design.md) · [图片展示边界](dev-log/2026-08-26-rag-image-display-boundary.md) · [阶段A落地](dev-log/2026-08-31-rag-stage-a-implementation.md) · [上线部署](dev-log/2026-08-31-neon-rag-deployment.md) · [消息落库排查](dev-log/2026-09-01-message-content-sanitize.md) · [rag-schema](learning-notes/rag-schema.md) · [pgvector](learning-notes/pgvector.md) · [embedding-dimensions](learning-notes/embedding-dimensions.md) · [ADR-003](decisions/003-neon-drizzle.md) |
