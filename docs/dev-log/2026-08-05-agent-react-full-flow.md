...
[api/chat/index.post.ts:114-146](https://github.com/qlhuo/holyer-ai/blob/main/server/api/chat/index.post.ts#L114-L146)
...
另外，有工具时 API 路由会向 system prompt 追加**工具调用准则**（[第 122-131 行](https://github.com/qlhuo/holyer-ai/blob/main/server/api/chat/index.post.ts#L122-L131)）：
...
[runner.ts:39-185](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/runner.ts#L39-L185)
...
[runner.ts:54-57](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/runner.ts#L54-L57)
...
[runner.ts:62-88](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/runner.ts#L62-L88)
...
[runner.ts:93-96](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/runner.ts#L93-L96)
...
[runner.ts:100-178](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/runner.ts#L100-L178)
...
[openai.ts:78-93](https://github.com/qlhuo/holyer-ai/blob/main/server/service/llm/openai.ts#L78-L93)
...
当对话历史中有 tool_calls 时，Provider 需要把内部格式回译成 OpenAI API 格式（[openai.ts:48-60](https://github.com/qlhuo/holyer-ai/blob/main/server/service/llm/openai.ts#L48-L60)）：
...
同理，tool 结果消息需要带 `tool_call_id` 关联（[openai.ts:68-73](https://github.com/qlhuo/holyer-ai/blob/main/server/service/llm/openai.ts#L68-L73)）：
...
[memory.ts](https://github.com/qlhuo/holyer-ai/blob/main/server/service/agent/memory.ts)
...
[api/chat/index.post.ts:148-206](https://github.com/qlhuo/holyer-ai/blob/main/server/api/chat/index.post.ts#L148-L206)
...
**增量写 DB 策略**（[api/chat/index.post.ts:189-192](https://github.com/qlhuo/holyer-ai/blob/main/server/api/chat/index.post.ts#L189-L192)）：
