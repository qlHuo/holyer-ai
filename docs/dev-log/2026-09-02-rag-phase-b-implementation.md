...
> **实施状态**：✅ M0–M4 全部完成，阶段 B 收官（2026-09-09）。M4 = 3.7 GitHub 文档引入见 [09-09 定稿](2026-09-09-github-doc-import-plan.md)。
...
[roadmap](../roadmap.md) 阶段 B 任务 3.5–3.8：上传 API、知识库 UI、GitHub 引入、图片展示 + 白名单渲染——**已全部完成，阶段 B 收官（2026-09-09）**。
